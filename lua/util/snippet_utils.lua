...
local function math_snippet(context, nodes, opts)
  ...
  opts.condition = function(...)
    return raw_cond(...) and vim.fn["vimtex#syntax#in_mathzone"]() == 1
  end
...
local function text_snippet(context, nodes, opts)
  ...
  opts.condition = function(...)
    return raw_cond(...) and vim.fn["vimtex#syntax#in_mathzone"]() == 0
  end
  return snippet(context, nodes, opts)
end
...
local postfix_command = function(trig, args)
  ...
  local resolve_expand_params = function(_, line_to_cursor, match, _)
    ...
    local postfix_match = match_multi(line_to_cursor_except_match, patterns)
    -- print(postfix_match)
  ...
  local opts = {
    condition = function()
      return not args.mathmode or vim.fn["vimtex#syntax#in_mathzone"]() == 1
    end,
  }
